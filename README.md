...
Phenoflow staff EMAIL: 

nodemailerEMAIL=phenoflow21@gmail.com
nodemailerPASS= France28
...
3. Add inside the `.env` file these two lines to configurate nodemailer: 
...
- Add images to [web/public/images](web/public/images) (live set available [here](https://drive.google.com/file/d/1sjsIYW7w88gEZYBIxXI-MYWFS9I5aMVH/view?usp=sharing)) [Please ignore the MACOS folder]
- Add fixtures to [web/cypress/fixtures] (live set available [here])(https://drive.google.com/file/d/1PONMyEkJAqsqegXvv4f3zSTZTN4x1iRe/view?usp=sharing) [Please ignore the MACOS folder]
...
4. Add an author account through this command:
...
5. Run server, referencing generated certificate:
...
`npx cypress open`
or `npx cypress run --headless` [To run without cypress GUI]
