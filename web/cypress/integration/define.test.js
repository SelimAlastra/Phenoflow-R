...
describe('Define', () => {
    ...
    it('[DEFINE5] The author should be able to define a phenotype definition',() => {
        ...
        cy.get('select').invoke('val', 'Step 1 description').select('python')
        ...
        cy.get('select').last().invoke('val', 'Step 2 description').select('python')
        ...
        cy.get('select').last().invoke('val', 'Step 3 description').select('python')
